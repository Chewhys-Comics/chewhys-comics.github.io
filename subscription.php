  ...
  <div class="wrapper">
    ...
    if(isset($_POST['subscribe'])){ //if subscribe btn clicked
      ...
      if(filter_var($userEmail, FILTER_VALIDATE_EMAIL)){ //validating user email
        $subject = "Thanks for Subscribing us - Chewhys Comics";
        $message = "Thanks for subscribing Chewhys Comics. You'll always receive updates from us. And we won't share and sell your information.";
        $sender = "From: stephanieyao.stu@gmail.com";
